...
%   some details information of the function:
%   1. shuffle the data for training
%   2. spilt the traning set and validation set
%   3. normalization(using maxium number)
%   4. add noise to the calculated h matrix
%   5. calculate the optimal beam index
%=========================================================================%
...
for i = 1:len% Normalize data
    ['reading file',num2str(i),'.......']
	load(fileName(i).name)
    rawData.labels = 0;              % can be deleted if needed
	x = rawData.channel;
    loc(i) = {rawData.loc};
