...
for ant = 1:length(num_ant_mm)% number of antennas to loop over
	...
	options.dataFile1 ='O1_3p5.mat';% The path to the sub-6 data file
    options.dataFile2 ='O1_28.mat';% The path to the mmWave data file
	...
	for p = 1:length(tx_power)
        ...
        save(['./Dataset/','dataset',num2str(p),'.mat'],'dataset','-v7.3');     % saving data into the mat file
% 		% Build network:
% 		% --------------
% 
